...
//!
//! `hisi_hal::timer::AsyncDelay` arms TIMER0 one-shot and parks the task until
//! the timer's completion IRQ (26) fires; `hisi_hal::asynch::block_on` runs the
...
use hisi_hal::timer::{self, AsyncDelay, TimerChannel};
